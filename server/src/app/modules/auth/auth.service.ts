...
export class AuthService {
    ...
    private async generateUniqueCustomUserId(): Promise<string> {
        let isUnique = false;
        let customUserId: string;

        while (!isUnique) {
            customUserId = Math.floor(
    ...
    async resetPassword(
        ...
        try {
            ...
            const isEmail = this.utilsService.validateEmail(
